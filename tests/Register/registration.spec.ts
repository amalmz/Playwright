...
test.describe('User Registration', () => {
    ...
    test('Register with empty fields', async () => {
        ...
        await expect(registrationPage.errorMessages).toHaveCount(5);

        await expect(registrationPage.errorMessages).toHaveText([
    ...
    test('Fill first name and last name', async () => {

        await registrationPage.fillFirstName('Amal');
        await registrationPage.fillLastName('Mzoughi');
